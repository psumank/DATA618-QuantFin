"""
Kalman Filtering pairs trading algorithm.
reference: https://www.quantopian.com/posts/quantopian-lecture-series-kalman-filters
"""
...
def initialize(context):
    ...
    context.pairs = [
        KalmanPairTrade(symbol('UPS'), symbol('JBHT'),
